package applica.api.api.configuration;

import applica.api.api.facade.AccountFacade;
import applica.api.api.permissions.PermissionMap;
...
public class ApplicationInitializer {
    ...
    private void setupPermissions() {
        ...
        for (String permission : applica.api.api.permissions.Permissions.getAllPermissions()) {
            Permissions.instance().registerStatic(permission);
        }
