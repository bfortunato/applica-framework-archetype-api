...
public class FileUtils {
    ...
    private static String generateTempPath(OptionsManager optionsManager, String report) {
        ...
        var tempDir = FilenameUtils.concat(optionsManager.get("applica.framework.fileserver.basePath"), TEMP_DIR_PATH);
        return String.format("%s%s_%s", tempDir, generatePrefix(), report);
    }
